...
import reducer, {
  ...
  reset,
  updateEntity,
} from './cancellation-policy.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CANCELLATIONPOLICY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CANCELLATIONPOLICY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CANCELLATIONPOLICY actions', async () => {
      const arg = { id: 11328 };
    ...
    it('dispatches UPDATE_CANCELLATIONPOLICY actions', async () => {
      const arg = { id: 11328 };
    ...
    it('dispatches PARTIAL_UPDATE_CANCELLATIONPOLICY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CANCELLATIONPOLICY actions', async () => {
      const arg = 42666;
