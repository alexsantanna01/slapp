...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './studio.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STUDIO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_STUDIO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_STUDIO actions', async () => {
      const arg = { id: 1489 };
    ...
    it('dispatches UPDATE_STUDIO actions', async () => {
      const arg = { id: 1489 };
    ...
    it('dispatches PARTIAL_UPDATE_STUDIO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_STUDIO actions', async () => {
      const arg = 42666;
