...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPECIALPRICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPECIALPRICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPECIALPRICE actions', async () => {
      const arg = { id: 16654 };
    ...
    it('dispatches UPDATE_SPECIALPRICE actions', async () => {
      const arg = { id: 16654 };
    ...
    it('dispatches PARTIAL_UPDATE_SPECIALPRICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPECIALPRICE actions', async () => {
      const arg = 42666;
