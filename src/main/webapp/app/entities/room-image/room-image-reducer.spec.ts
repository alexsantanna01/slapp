...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ROOMIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ROOMIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ROOMIMAGE actions', async () => {
      const arg = { id: 19121 };
    ...
    it('dispatches UPDATE_ROOMIMAGE actions', async () => {
      const arg = { id: 19121 };
    ...
    it('dispatches PARTIAL_UPDATE_ROOMIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ROOMIMAGE actions', async () => {
      const arg = 42666;
