...
export const ReservationDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/reservation${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="slappApp.reservation.delete.question">
        <Translate contentKey="slappApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
