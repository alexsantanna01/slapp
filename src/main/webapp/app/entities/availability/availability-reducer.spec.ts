...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVAILABILITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AVAILABILITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AVAILABILITY actions', async () => {
      const arg = { id: 30144 };
    ...
    it('dispatches UPDATE_AVAILABILITY actions', async () => {
      const arg = { id: 30144 };
    ...
    it('dispatches PARTIAL_UPDATE_AVAILABILITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AVAILABILITY actions', async () => {
      const arg = 42666;
