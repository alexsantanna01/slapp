...
public class ReservationTestSamples {
    ...
    public static Reservation getReservationSample1() {
        return new Reservation().id(1L).cancelReason("cancelReason1");
    }

    public static Reservation getReservationSample2() {
        return new Reservation().id(2L).cancelReason("cancelReason2");
    }

    public static Reservation getReservationRandomSampleGenerator() {
        return new Reservation().id(longCount.incrementAndGet()).cancelReason(UUID.randomUUID().toString());
    }
}
